...
export async function fetchRelationshipMapConnections(
  ...
  // manual contact's own identity — resolving a Clerk name for it leaked the
  // owner's own display name onto every manually-added friend whenever the
  // owner set/changed their name. Skip the lookup entirely for those rows.
