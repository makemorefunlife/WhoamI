...
const STAMINA_COPY: Record<StaminaArchetype, string> = {
...
const FANTASY_COPY: Record<FantasyArchetype, string> = {
...
const MANNER_COPY: Record<MannerArchetype, string> = {
...
export function buildBedroomMatrixSection(params: {
  ...
  const profileA = {
    stamina: STAMINA_COPY[archA.stamina],
    fantasy: FANTASY_COPY[archA.fantasy],
    manner: MANNER_COPY[archA.manner],
  };
  const profileB = {
    stamina: STAMINA_COPY[archB.stamina],
    fantasy: FANTASY_COPY[archB.fantasy],
    manner: MANNER_COPY[archB.manner],
  };
