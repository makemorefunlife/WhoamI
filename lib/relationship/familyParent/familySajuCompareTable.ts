...
> = {
  "ko-KR": {
    ...
    mother: {
      low: "같은 반응 타입이라 감정이 겹칠 일이 적고, 지금 마찰도 낮은 편이에요.",
      medium: "같은 반응 타입끼리 감정이 겹치면 중간 마찰이 날 수 있어요 — 서운함보다 ‘한 줄 사실 + 한 줄 요청’으로 짧게 정리하는 게 도움이 돼요.",
      high: "같은 반응 타입끼리라 감정 온도가 겹치며 마찰이 커지기 쉬워요 — 평가는 줄이고 짧은 대화로 마무리하세요.",
    },
    father: {
