...
function buildOfficeBaseline(
  ...
  return {
    ...
    evidence: {
      ...
      summary: pick(
        locale,
        "Even when the pair's cross-signals don't spike sharply on any one topic, small misunderstandings compound heavily in a coworker relationship. Below is a preventive baseline prescription.",
    ...
    do_list: pick(
      locale,
      [
        `10 minutes every Friday: '1 thing I appreciated this week · 1 thing that fell short' — ${nicknameA} and ${nicknameB} take turns.`,
        "Always specify channel, deadline, and completion criteria for any work request.",
        "If a conflict can't be resolved same-day, carry it over only as 'Monday's first meeting agenda item.'",
      ],
      [
    ...
    dont_list: pick(
      locale,
      [
        "Firing off long, emotional chat messages back to back — keep it short, and call for 5 minutes if it's complicated.",
        "Mocking the other's approach in front of coworkers.",
        "Announcing a sudden scope change the night before a deadline.",
      ],
      [
