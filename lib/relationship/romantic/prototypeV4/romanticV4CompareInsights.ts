    ...
    case "conflict":
      return {
        manifestation: isEn
          ...
          : `갈등 상황에서 "${leanALabel}" 쪽인 ${nameA}와 "${leanBLabel}" 쪽인 ${nameB}로 갈리는 편이에요. 문제를 풀어가는 기본 호흡이 달라서, 서로의 대처 방식을 무관심이나 고집으로 오해하기 쉬워요.`,
        understanding: isEn
    ...
    case "stress":
      return {
        manifestation: isEn
          ...
          : `스트레스를 받을 때 "${leanALabel}" 쪽인 ${nameA}와 "${leanBLabel}" 쪽인 ${nameB}로 갈려요. 압박감을 다루는 방식이 달라서, 힘든 순간의 행동이 상대방에게는 거절이나 예민함으로 보일 수 있어요.`,
        understanding: isEn
    ...
    case "communication":
      return {
        manifestation: isEn
          ...
          : `대화할 때 "${leanALabel}" 쪽인 ${nameA}와 "${leanBLabel}" 쪽인 ${nameB}로 나뉘어요. 소통 방식이 달라서, 정작 하려던 말의 내용보다 어조나 타이밍이 먼저 다툼의 원인이 되곤 합니다.`,
        understanding: isEn
    ...
    case "affection":
      return {
        manifestation: isEn
          ...
          : `애정 표현에서 "${leanALabel}" 쪽인 ${nameA}와 "${leanBLabel}" 쪽인 ${nameB}로 갈리는 편이에요. 사랑을 주고받는 언어가 달라서, 마음은 크지만 서로에게 잘 가닿지 않을 때가 있어요.`,
        understanding: isEn
    ...
    case "expression":
      return {
        manifestation: isEn
          ...
          : `감정 표현에서 "${leanALabel}" 쪽인 ${nameA}와 "${leanBLabel}" 쪽인 ${nameB}로 갈려요. 마음을 꺼내놓는 속도와 밀도가 달라서, 한 사람은 조급함을 느끼고 다른 사람은 부담을 느끼기 쉽습니다.`,
        understanding: isEn
    ...
    case "decision":
      return {
        manifestation: isEn
          ...
          : `결정을 내릴 때 "${leanALabel}" 쪽인 ${nameA}와 "${leanBLabel}" 쪽인 ${nameB}로 갈려요. 속도 중심과 합의 중심, 서로 기준이 달라서 일정이나 계획을 정할 때마다 작은 마찰이 생기곤 합니다.`,
        understanding: isEn
