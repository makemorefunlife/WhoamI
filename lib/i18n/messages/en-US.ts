...
export const messagesEnUS = {
  ...
  report: {
    ...
    chartInfoPopover:
      "This chart uses your actual analysis results.\nCurrent Patterns reflects your behavioral survey, while Natural Tendencies reflects your innate profile.",
    currentVsEssenceTitle: "Current Patterns vs. Natural Tendencies",
    aboutChartAria: "About this chart",
    aboutChartTitle: "Survey patterns (current) overlaid with birth-chart traits (natural tendencies)",
    currentStateLabel: "Current Patterns",
    essencePotentialLabel: "Natural Tendencies",
  ...
  landing: {
    ...
    personalInnateTitle: "Natural Tendencies",
    ...
    personalCurrentTitle: "Current Patterns",
    ...
    personalRealizedTitle: "Current Patterns",
  ...
  relationshipDrilldown: {
    romantic: {
      ...
      scoreLabelSensitivity: "Friction",
    },
    work: {
    ...
    family: {
      ...
      relationshipIndexCardTitle: "Parenting Friction",
      relationshipIndexSafeDistanceLabel: "Comfortable Distance",
    ...
    layout: {
      ...
      scoreIndexEyebrow: "At a Glance",
      scoreIndexTitle: "Your scores, at a glance",
      scoreCalcAria: "How these scores are calculated",
      ...
      tensionAxisLegend: "Where You Clash",
      similarAxisLegend: "Where You Match",
      complementaryAxisLegend: "Where You Balance Each Other",
      radarFootnote:
  ...
  blueprint: {
    ...
    currentTitle: "Current Patterns",
    surveyResultLabel: "(Survey results)",
    axisChartLabel: "6 Core Tendencies",
    backToBlueprint: "Back to Blueprint",
    viewEssenceProfile: "View Natural Tendencies →",
    essenceTitle: "Natural Tendencies",
    ...
    viewCurrentProfile: "View Current Patterns (Survey Results) →",
