  ...
  sections: [
    {
      ...
      title: "1. 개요",
      paragraphs: [
        "아하잇츠미(이하 \"운영자\")는 Ahaitsme를 운영합니다. Ahaitsme는 출생 정보와 18문항 설문, 사주·점성 계산, AI 통합 해석을 결합해 개인 리포트와 친구 초대 기반 관계 분석을 제공하는 자기 이해·관계 탐색 서비스입니다.",
    ...
    },
    {
      ...
      listItems: [
        ...
        "설문: 18문항 Y/N 응답 및 이를 바탕으로 한 성향·행동 패턴 코드",
