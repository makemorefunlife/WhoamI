...
const FAMILY_CLOSING_FALLBACKS: Record<string, string> = {
  DECISION: "스스로 판단하고 선택하는 기준은 이미 충분해요. 내 결정을 믿고 나아갈 때 진정한 나다움이 살아납니다.",
  STRUCTURE: "상황을 체계적으로 정리하는 원칙은 유용한 힘이 됩니다. 완벽한 기준을 기다리기보다 가볍게 첫발을 내딛어 보세요.",
  GROWTH: "새로운 가능성을 탐색하고 배움을 넓히는 힘이 나를 움직입니다. 타인의 기준이 아닌 나의 속도로 성장을 시도하세요.",
  ADAPTABILITY: "상황에 맞춰 유연하게 대처하는 적응력은 귀한 강점입니다. 타인에게 맞추는 유연함 속에서도 내 중심 기준을 든든히 지켜가세요.",
  BOUNDARY: "내 한계와 감당 범위를 지키는 지혜가 필요합니다. 상대를 배려하더라도 상대가 감당해야 할 책임까지 혼자 짊어지지 않아도 괜찮습니다.",
};
