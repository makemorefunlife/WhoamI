...
export default function AddFriendSheet({
  ...
  return (
    <div
      className="fixed inset-0 z-[100] flex items-end justify-center bg-primary/25 backdrop-blur-[2px]"
      role="dialog"
      aria-modal="true"
      onClick={onClose}
    >
      <motion.div
        ...
        className={`${hubSheetClass()} max-h-[92dvh] w-full overflow-y-auto rounded-b-none p-5 sm:max-w-lg sm:rounded-extra-large sm:p-6`}
      ...
      >
        ...
        <div className="mb-5 flex gap-2 rounded-full bg-surface-container-low/80 p-1">
          {(
            [
              ["invite", "초대 링크"],
              ["manual", "직접 입력"],
        ...
        {tab === "invite" ? (
          ...
          <div className="stitch-manual-form -mx-1 rounded-2xl border border-outline-variant/25 bg-surface-container-low/30 p-4">
