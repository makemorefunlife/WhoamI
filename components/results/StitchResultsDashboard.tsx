      ...
      <section className="space-y-4">
        ...
        <AnimatePresence mode="wait">
          {activeTab ? (
            ...
            >
              {isGuest
                ? messages.report.guestOpenAnalysisHint
                : messages.report.openAnalysisHint}
            </motion.p>
          )}
        </AnimatePresence>
      </section>
