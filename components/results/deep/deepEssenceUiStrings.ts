...
const EN: DeepEssenceUiStrings = {
  summaryLabels: {
    coreMode: "Your Core Pattern",
    energyBalance: "Energy You Give / Energy Back to You",
    growthEdge: "Growth Opportunity",
  },
  radar: {
    caption: "Current Patterns vs. Natural Tendencies",
    current: "Current Patterns",
    potential: "Natural Tendencies",
  },
  axisInterpretation: {
    ...
    naturalTendencyLabel: "Natural Tendencies",
    currentPatternLabel: "Current Patterns",
  ...
  part2: {
    ...
    metaPrefix: "Energy You Give",
    fuels: "Fuels",
    drains: "Drains",
    optimal: "Optimal",
    relationalSpend: "Energy You Give",
    selfReturn: "Energy Back to You",
    others: "Others",
...
const KO: DeepEssenceUiStrings = {
  summaryLabels: {
    coreMode: "나의 핵심 패턴",
    energyBalance: "관계에 쓰는 에너지 / 나에게 돌아오는 에너지",
    growthEdge: "지금 더 키워갈 힘",
  },
  radar: {
    caption: "현재 행동 성향 vs. 타고난 성향",
    current: "현재 행동 성향",
    potential: "타고난 성향",
  },
  axisInterpretation: {
    ...
    naturalTendencyLabel: "타고난 성향",
    currentPatternLabel: "현재 행동 성향",
  ...
  part2: {
    ...
    metaPrefix: "관계에 쓰는 에너지",
    fuels: "채워주는 것",
    drains: "빼앗는 것",
    optimal: "최적의 환경",
    relationalSpend: "관계에 쓰는 에너지",
    selfReturn: "나에게 돌아오는 에너지",
    others: "타인",
