/**
 * Capture Romantic V4 prototype pages (complete + anti-overfit + en smoke).
 * Run: npx tsx tests/scripts/capture-romantic-v4-prototype.mjs
 */
...
const OUT = path.resolve("tests/artifacts/romantic-v4-prototype");
...
const targets = [
  {
    id: "complete-ko",
    url: `${BASE}/dev/romantic-v4-content-prototype?variant=complete&locale=ko-KR`,
    viewports: [
  ...
  },
  {
    ...
    url: `${BASE}/dev/romantic-v4-content-prototype?variant=complete&locale=en-US`,
    viewports: [{ suffix: "desktop", width: 1280, height: 920 }],
  },
  {
    id: "tension-ko-check",
    url: `${BASE}/dev/romantic-v4-content-prototype?variant=tension&locale=ko-KR`,
    viewports: [{ suffix: "desktop", width: 1280, height: 920 }],
  },
  {
    id: "minimal-ko-check",
    url: `${BASE}/dev/romantic-v4-content-prototype?variant=minimal&locale=ko-KR`,
    viewports: [{ suffix: "desktop", width: 1280, height: 920 }],
  },
];
  ...
  for (const t of targets) {
    for (const viewport of t.viewports) {
      ...
      const info = await page.evaluate(() => {
        const root =
          document.querySelector("[data-v4-prototype-root]") ?? document.body;
