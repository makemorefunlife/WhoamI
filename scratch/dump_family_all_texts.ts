...
const raw = fs.readFileSync("scratch/family_review_output.json", "utf-8");
const pkg = JSON.parse(raw);

let out = "";
out += "====================================================\n";
out += "=== CURRENT FAMILY REPORT PROD/CE OUTPUT (KO-KR) ===\n";
out += "====================================================\n";
const cFamily = pkg.ko.current.report.family ?? pkg.ko.current.report;
out += JSON.stringify(cFamily, null, 2) + "\n";
...
fs.writeFileSync("scratch/family_texts_utf8.txt", out, "utf-8");
console.log("Written scratch/family_texts_utf8.txt successfully");
