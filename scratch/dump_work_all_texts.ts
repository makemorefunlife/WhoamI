...
const raw = fs.readFileSync("scratch/work_review_output.json", "utf-8");
const pkg = JSON.parse(raw);

let out = "";
out += "==================================================\n";
out += "=== CURRENT WORK REPORT PROD/CE OUTPUT (KO-KR) ===\n";
out += "==================================================\n";
const cWork = pkg.ko.current.report.work ?? pkg.ko.current.report;
out += JSON.stringify(cWork, null, 2) + "\n";
...
fs.writeFileSync("scratch/work_texts_utf8.txt", out, "utf-8");
console.log("Written scratch/work_texts_utf8.txt successfully");
